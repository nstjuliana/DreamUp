...
Stores batch test execution reports for parallel testing.
...
**Constraints:**
- `status` must be one of: 'running', 'completed', 'partial_failure'
- `execution_method` must be one of: 'cli', 'web'
